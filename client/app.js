...
function render(){
  ...
  $('banner').innerHTML=`<div class="flash"><div><b>1% protocol fee</b> only when milestone funds are released. Pledges and refunds are free. Program <span class="mono">${state.config.programId.slice(0,8)}…</span></div></div>`;
